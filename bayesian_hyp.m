function [new] = bayesian_hyp(prev, curr, trans)
   ...
   % Increase certainty       
    ...
    % Certainty saturation parameter for display
    % Prevent old readings from fastly
    top_probability_limit = 25;  % 225; 
...
%     disp_hyp(disp_hyp > top_probability_limit) = top_probability_limit;
